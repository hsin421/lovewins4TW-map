...
const fetchData = () => axios.get('https://5bq2v7mgi5.execute-api.us-east-1.amazonaws.com/prod/mySimpleBE?TableName=ME-TW');


const K_EMUL_ROUNDTRIP_TIME_MS = 0;
...
const asyncActions = {
  ...
  async query(params) {
    return await fetchData().then(json => getDataAsync(K_EMUL_ROUNDTRIP_TIME_MS, genMarkersData({...params, data: json.data})));
  },
